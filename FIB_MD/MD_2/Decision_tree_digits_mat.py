...
digits = pd.read_csv("/home/david/Escritorio/MD/DecisionTrees/Project2/k-nn/clean_knn_student_mat.csv")
...
clf = tree.DecisionTreeClassifier(criterion='entropy', min_samples_split=57, min_impurity_split=0.9500000000000001)
clf = clf.fit(X_train, y_train)
pred = clf.predict(X_test)
