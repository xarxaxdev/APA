...
static const char qt_meta_stringdata_MyLabel[] = {
    "MyLabel\0\0exempleSignal()\0setColor()\0"
    "saveR(int)\0saveG(int)\0saveB(int)\0"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->saveR((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->saveG((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->saveB((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
