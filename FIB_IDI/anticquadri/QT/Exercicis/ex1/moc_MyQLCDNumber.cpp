...
static const char qt_meta_stringdata_MyQLCDNumber[] = {
    "MyQLCDNumber\0\0exempleSignal()\0"
    "displayZero()\0changeValueColor(int)\0"
};
...
void MyQLCDNumber::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->displayZero(); break;
        case 2: _t->changeValueColor((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
