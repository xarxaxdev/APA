...
void MyGLWidget::createBuffers ()
{
  ...
  glm::vec3 amb(0.09,0.03,0.1);
  glm::vec3 diff(0.6,0.2,0.7);
  glm::vec3 spec(1.,1.,1.);
  float shin = 100;
...
void MyGLWidget::modelTransformPatricio ()
{
  ...
  TG=glm::rotate(TG,Rrotate,glm::vec3(0,1,0));
...
void MyGLWidget::modelTransformPatricio3 ()
{
  glm::mat4 TG;  // Matriu de transformació
  TG=glm::rotate(TG,Rrotate,glm::vec3(0,1,0));
  TG=glm::translate(TG,glm::vec3(0,0,1.5));
  TG=glm::scale(TG, glm::vec3(scale,scale, scale));
...
void MyGLWidget::modelTransformPatricio4 ()
{
  ...
  TG=glm::translate(TG,glm::vec3(0,0,-1.5));
  TG=glm::scale(TG, glm::vec3(scale,scale, scale));
  TG=glm::rotate(TG,(float)0 ,glm::vec3(0 , 1, 0 ));
  TG = glm::translate(TG, -centreBasePatr);
  glUniformMatrix4fv (transLoc, 1, GL_FALSE, &TG[0][0]);
}
...
void MyGLWidget::keyPressEvent (QKeyEvent *e)
{
  switch (e->key())
  {
    ...
    case Qt::Key_M:
     ...
     case Qt::Key_C:
      glm::Mat4 View;
      View=glm::translate(glm::mat4(1.f),glm::vec3(0.,1.5,0.));
      glm::mat4 Proj;
      Proj= glm:.perspective(M_PI/3., 1., 1., 30);
      updateGL();
      break;
