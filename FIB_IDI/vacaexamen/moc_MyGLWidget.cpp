...
QT_MOC_LITERAL(3, 25, 9) // "changeFOV"

    },
    "MyGLWidget\0valuechanged\0\0changeFOV"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::valuechanged)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyGLWidget::valuechanged(int _t1)
{
