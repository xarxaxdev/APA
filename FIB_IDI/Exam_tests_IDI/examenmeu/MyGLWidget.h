...
public slots:
  ...
  private:
    ...
    //afegit
    float xampl, FOV, rw, desplpilota;
    //uniforms afegits
    GLuint color;
    ...
    GLuint VAO_Pil, VBO_PilPos, VBO_PilNorm, VBO_PilMatamb, VBO_PilMatdiff, VBO_PilMatspec, VBO_PilMatshin;
    GLuint VAO_Porteria, VBO_PorteriaPos, VBO_PorteriaNorm, VBO_PorteriaMatamb, VBO_PorteriaMatdiff, VBO_PorteriaMatspec, VBO_PorteriaMatshin;
    ...
    glm::vec3 centreBasePat, centreBasePil;
