...
void MyGLWidget::paintGL () 
{
  ...
  //suposo que aqui és on fare alguna transformacio i tornare a pintar el patricio
...
void MyGLWidget::carregaShaders()
{
  ...
  //transSCO=glGetUniformLocation(program->programId(),"NormalMatrix");
}
...
void MyGLWidget::modelTransformPatricio2 ()
{
  float angle= M_PI;
  glm::vec3 capamunt;
  capamunt[0]=0; capamunt[1]=2; capamunt[2]=0;
  TG = glm::mat4(1.f);  // Matriu de transformació
  TG = glm:: translate (TG,capamunt);
